module.exports = {
    ...
    meta: { version: "2.1.6", preciseCheck: false, author: 'Gotowka', authorUrl: 'https://github.com/Gotowka/dbmmody/blob/main/beta/loggerleave.js', downloadUrl: 'https://github.com/Gotowka/dbmmody/blob/main/beta/loggerleave.js' },
  ...
  <input id="call" class="round" type="number">
    ...
    async action(cache) {
      ...
      const { invites } = require('../actions/loggerjoin')
      ...
      cc.on('guildMemberRemove', async (member) => {
